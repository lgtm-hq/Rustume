...
- **deps**: update lintro to 0.170.0 (minor) (#1000) (b8e9382)
- **deps**: update dependency jsdom to 30.1.1 (patch) (#999) (e601abb)
- **deps**: update lintro (#997) (1d73be5)
- **deps**: update dependency oxlint to 1.85.0 (minor) (#996) (e0f8964)
- switch harden-runner back to block on Docker publish and release verify (#998)
  (aacd153)
- bump lgtm-ci to v0.74.6 and drop duplicate Renovate tooling-ref manager (#994)
  (cfad708)
- **deps**: update github/codeql-action action to v4.38.2 (patch) (#995) (cd610a4)
- **deps**: update postgres:18-alpine docker digest to 77f5851 (#991) (3d5f631)
- **deps**: update rust:1.98-alpine docker digest to 7cc1c22 (#992) (1c67563)
- **deps**: update dependency @types/node to 26.6.2 (patch) (#990) (1b006e5)
- **deps**: update lintro to 0.168.3 (patch) (#989) (4d5c20b)
- **deps**: update renovatebot/github-action action to v46.3.3 (patch) (#988) (1591b3d)
- **deps**: update lintro to 0.168.1 (minor) (#987) (4ceabc4)
- **deps**: update renovatebot/github-action action to v46.3.2 (patch) (#986) (50ae912)
- **deps**: lock file maintenance (#985) (0de7762)
- **deps**: lock file maintenance (#984) (30bb21d)
- **deps**: update lintro to 0.167.0 (minor) (#983) (cb2f2b9)
- **deps**: update lintro to 0.166.0 (minor) (#982) (54daf9d)
- **deps**: update dependency jsdom to 30.1.0 (minor) (#980) (fc81a86)
