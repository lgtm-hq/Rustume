...
function resumeNamed(name: string): ResumeData {
  return {
    ...
    sections: {
      ...
      projects: { id: "projects", name: "Projects", columns: 1, visible: true, separateLinks: true, items: [] },
      profiles: { id: "profiles", name: "Profiles", columns: 1, visible: true, separateLinks: true, items: [] },
      awards: { id: "awards", name: "Awards", columns: 1, visible: true, separateLinks: true, items: [] },
      certifications: {
        id: "certifications",
        name: "Certifications",
        columns: 1,
      ...
      languages: { id: "languages", name: "Languages", columns: 1, visible: true, separateLinks: true, items: [] },
      interests: { id: "interests", name: "Interests", columns: 1, visible: true, separateLinks: true, items: [] },
      volunteer: { id: "volunteer", name: "Volunteer", columns: 1, visible: true, separateLinks: true, items: [] },
      references: { id: "references", name: "References", columns: 1, visible: true, separateLinks: true, items: [] },
      custom: {},
    },
    metadata: {
      template: "onyx",
