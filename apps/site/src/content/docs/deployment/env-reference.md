...
| `RATE_LIMIT_ACCOUNT_EXPORT_PER_MIN` | `5` | GDPR account data export (`GET /api/account/export`, per user) |
| `RATE_LIMIT_ACCOUNT_DELETE_PER_MIN` | `5` | Account deletion (`DELETE /api/account`, per user) |
