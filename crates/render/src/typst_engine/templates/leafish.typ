...
#let render-experience(item) = {
  ...
  if item.summary != "" {
    v(4pt)
    text(size: 9.5pt)[#render-rich-text(item.summary)]
  }
...
#let render-skill(item) = {
  ...
  grid(
    ...
    [
      ...
      #if item.description != "" {
        v(1pt)
        text(size: 8.5pt, fill: muted-color)[#render-rich-text(item.description)]
      }
    ],
  ...
  grid(
    ...
    [
      // Summary
        ...
        text(size: 9.5pt)[#render-rich-text(data.sections.summary.content)]
      }
