...
///
/// **Limitation:** Does not correctly handle parenthesized URLs like
/// `(https://example.com)` - the closing parenthesis will be stripped.
/// For markdown-style `[text](url)` links, use a dedicated parser.
