...
use crate::routes::{
    ...
    public_resume_data, public_resume_page, public_resume_preview, render_pdf, render_preview,
    restore_resume_version, robots_txt, security_txt, spa_fallback, static_dir, template_thumbnail,
    update_resume, update_sharing, validate, version,
};
